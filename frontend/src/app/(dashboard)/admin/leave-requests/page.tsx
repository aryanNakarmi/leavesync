...
export default function LeaveRequestsPage() {
  return (
    <div className="max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold text-on-surface mb-2">Leave Requests</h1>
      <p className="text-on-surface-variant mb-8">Review and manage employee leave requests</p>
