          ...
          >
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={withdrawing}
                className="px-4 py-2 rounded-lg text-sm font-medium text-on-primary bg-error hover:shadow-md hover:-translate-y-0.5 disabled:opacity-50 transition-all duration-200 flex items-center gap-2"
              >
                {withdrawing ? (
        ...
        <div className="bg-white rounded-lg border border-outline-variant p-12 text-center">
          ...
          {activeTab === "ALL" && (
            <button
              ...
              className="mt-4 px-4 py-2 bg-primary text-on-primary rounded-lg text-sm font-medium hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 active:scale-[0.97]"
            >
              Apply for Leave
            </button>
          )}
